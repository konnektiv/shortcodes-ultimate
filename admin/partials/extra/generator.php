...
<div class="su-generator-extra-banner">
	...
	<div class="su-generator-extra-banner-content">
		...
		<img src="<?php echo esc_attr( $this->get_image_url( 'screenshots/' . $data['id'] . '.png' ) ); ?>" class="su-generator-extra-banner-screenshot">
	</div>
</div>
